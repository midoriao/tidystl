...
fragment choices this is an input-acceptance effect, and it is the coverage
finding marked in \cref{tab:divergence-matrix}.
...
in spirit but is computed on the discrete grid.
...
This is a sign change in the robustness value, not a difference in input
acceptance: both backends evaluate the formula, and only the reported
value---and hence the verdict---differs. The \emph{signal beyond horizon} rule
is therefore a robustness effect, like the signal model.
