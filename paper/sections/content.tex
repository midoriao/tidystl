...
In this paper, we focus on the comparison of \tool{} with Breach, RTAMT, and STLCG++, which employ the quantitative STL semantics of Donz\'e and Maler~\cite{donze2010robust} as the explicit semantics.
...
For programming details, the artifact repository gives the user manual (\texttt{docs/usage.md}) and reference implementations. In \cref{sec:implement-variations}, we demonstrate that emulating an existing tool's behavior requires only localized changes to the backend with small effort.
