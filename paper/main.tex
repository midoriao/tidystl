...
These call this behavior \emph{implicit semantics},
...
Using a set of controlled cross-tool comparison cases, tidySTL identifies and localizes differences in implicit semantics among existing tools.
