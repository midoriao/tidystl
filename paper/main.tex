...
Its architecture also serves as an extensible evaluator layer: representative variations require only modular backend changes, while the formula, signal, and public interface remain fixed.
\end{abstract}
