...
% gives each sample's real time; dashed line = value 0; signals are blue; orange
...
\end{tikzpicture}
&
% ---- (iii) robustness at horizon: x = y = 5, -3 at t = 0, 1; readout at t = 1 ----
\begin{tikzpicture}[xscale=1.45,yscale=1.3775,baseline={(0,0.30cm)},line width=0.9pt,line cap=round]
  ...
  \node[font=\scriptsize,blue,anchor=west] at ({\sigX{0}+0.12},{\sigY{5}}) {$x=y$};
  \draw[readoutorange,line width=1.0pt] (p2) circle (2.8pt);
