...
class TestEndToEnd:
    ...
    def test_and_or_combination(self) -> None:
        """(p and q) or r."""
        ...
        # Breach extends penultimate value at outermost binary op
        np.testing.assert_allclose(rho[0], [1.0, -1.0, -1.0, 5.0, 5.0])
        # Note: the Breach backend extends the final output for the outermost binary op.
